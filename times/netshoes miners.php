...
<head> 
  <meta charset="utf-8"> 
  <title> Netshoes Miners </title> 
  <link rel="stylesheet" type="text/css" href="../cssdostimes/stylenetshoes.css"> 
  ...
  <div class="navigation"></div>
    ...
    <div class="menu"><img class ="home" src="../image/home.png" width="20">
       ...
       <!-- cards -->
       <div class="logoteam">
            <img src="../image/netshoes.png" alt="netshoes" title="netshoes" width="200">
       </div>

       <div class="teamroster">
            <img class='team' src="../image/netshoesroster.png" alt="teamnetshoes" title="teamnetshoes" height="200" width="350">
       </div>
                   ...
                   <tbody>
                       <tr> 
                            <?php
                                ...
                                and teamname in (SELECT teamname FROM `cblol` WHERE teamname = 'netshoes miners')
