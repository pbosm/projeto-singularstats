...
<head> 
  ...
  <div class="navigation"></div>
    ...
    <div class="menu"><img class ="home" src="../image/home.png" width="20">
       ...
       <!-- cards -->
       <div class="logoteam">
           <img src="../image/intz.png" alt="intz" title="intz" width="300">
       </div>

       <div class="teamroster">
            <img class='team' src="../image/intzacademyroster.png" alt="teamintz" title="teamintz" height="200" width="320">
       </div>
                   ...
                   <tbody>
                       <tr> 
                            <?php
                                ...
                                and teamname in (SELECT teamname FROM `cblol` WHERE teamname = 'intz academy')
