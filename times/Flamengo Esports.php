  ...
  <div class="navigation"></div>
    ...
    <div class="menu"><img class ="home" src="../image/home.png" width="20">
       ...
       <div class="teamroster">
           <img class='team' src="../image/flamengoroster.png" alt="teamflamengo" title="teamflamengo" height="200" width="350">
       </div>
                   ...
                   <tbody>
                       <tr> 
                            <?php
                                ...
                                and teamname in (SELECT teamname FROM `cblol` WHERE teamname = 'flamengo esports')
