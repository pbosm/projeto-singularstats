...
<head> 
  <meta charset="utf-8"> 
  <title> Rensga Academy </title> 
  <link rel="stylesheet" type="text/css" href="../cssdostimes/stylerensgaa.css">
  ...
  <div class="navigation"></div>
    ...
    <div class="menu"><img class ="home" src="../image/home.png" width="20">
       ...
       <!-- cards -->
       <div class="logoteam">
           <img src="../image/rensga.png" alt="rensga" title="rensga" width="195">
       </div>

       <div class="teamroster">
            <img class='team' src="../image/rensgaacademyroster.png" alt="teamrensga" title="teamrensga" height="200" width="350">
       </div>
                   ...
                   <tbody>
                       <tr> 
                            <?php
                                ...
                                and teamname in (SELECT teamname FROM `cblol` WHERE teamname = 'rensga academy')
