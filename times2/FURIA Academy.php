  ...
  <div class="navigation"></div>
    ...
    <div class="menu"><img class ="home" src="../image/home.png" width="20">
       ...
       <div class="teamroster">
           <img class='team' src="../image/furiaacademyroster.png" alt="teamfuria" title="teamfuria" height="200" width="350">
       </div>
                   ...
                   <tbody>
                       <tr> 
                            <?php
                                ...
                                and teamname in (SELECT teamname FROM `cblol` WHERE teamname = 'furia academy')
