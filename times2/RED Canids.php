        ...
        <div class="row g-4">
            <div class="col-sm-6 col-xl-6">
                <div class="text-center rounded p-4">
                    <div class="logoteam-red mt-3">
                        <img src="../image/red-canids.png" alt="<?php $nameteam ?>" title="<?php $nameteam ?>"
                            width="250">
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-6">
                <div class="text-center rounded p-4">
                    <div class="teamroster mt-3">
                        <img class='team' src="../image/redacademyroster.png" alt="<?php $nameteam ?>"
