            ...
            <div class="col-sm-6 col-xl-6">
                <div class="text-center rounded p-4">
                    <div class="logoteam mt-3">
                        <img src="../image/furia.png" alt="<?php echo $nameteam ?>" title="<?php echo $nameteam ?>" width="200">
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-6">
                <div class="text-center rounded p-4">
                    <div class="teamroster mt-3">
                        <img class='team' src="../image/furiaroster.png" alt="<?php echo $nameteam ?>"
                            title="<?php echo $nameteam ?>" height="200">
                    </div>
                </div>
            </div>
        </div>
