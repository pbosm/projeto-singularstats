...
<head> 
  <meta charset="utf-8"> 
  <title> Pain Gaming Academy </title> 
  <link rel="stylesheet" type="text/css" href="../cssdostimes/stylepaina.css"> 
  <div class="navigation"></div>
    ...
    <div class="menu"><img class ="home" src="../image/home.png" width="20">
       ...
       <div class="teamroster">
            <img class='team' src="../image/painacademyroster.png" alt="teampain" title="teampain" height="200" width="350">
       </div>
                   ...
                   <tbody>
                       <tr> 
                            <?php
                                ...
                                and teamname in (SELECT teamname FROM `cblol` WHERE teamname = 'pain gaming academy')
