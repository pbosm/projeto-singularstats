...
<head> 
  <meta charset="utf-8"> 
  <title> Rensga Esports </title> 
  <link rel="stylesheet" type="text/css" href="../cssdostimes/stylerensga2.css"> 
  <div class="navigation"></div>
    ...
    <div class="menu"><img class ="home" src="../image/home.png" width="20">
       ...
       <div class="teamroster">
            <img class='team' src="../image/rensgaroster.png" alt="teamrensga" title="teamrensga" height="200" width="350">
       </div>
                   ...
                   <tbody>
                       <tr> 
                            <?php
                                ...
                                and teamname in (SELECT teamname FROM `cblol` WHERE teamname = 'rensga esports')
